...
module.exports = React.createClass({displayName: "exports",
	...
	render: function() {
		var bars = _.range(manaBars + 1).map(function(value) {
			return (
				React.createElement(ManaBar, {label: value, manaClick: this._clickMana, ratio: this.state.ratio[value], value: this.state.curve[value] != null ? this.state.curve[value] : 0, key: value})
			);
		}.bind(this));

		return (
			React.createElement("ul", {className: "mana-curve"}, 
				bars
			)
		);
	},
